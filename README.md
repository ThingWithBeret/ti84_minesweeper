A minesweeper recreation made specifically for the TI-84 Plus CE calculator. The source code is mostly a one-filer in src/main.c. In the app, use the `clear` key to exit. 
